...
- [ ] `sdp eval --skill oneshot` runs all evals for the oneshot skill
- [ ] Eval cases defined as YAML: input transcript + expected/forbidden patterns
- [ ] Core evals for oneshot:
...
- [ ] Human-readable report with pass/fail per case
- [ ] Test: eval suite itself is tested — known-good and known-bad transcripts

...
- [ ] Same checkpoint-based gate logic as Cursor version
- [ ] Works with Claude Code's `stop_hook_active` flag
- [ ] Exit code 2 blocks with continuation message
- [ ] Test: Claude Code agent stopped before CI → blocked; after CI green → allowed

...
- [ ] Zero `go test`, `go build`, `go vet`, `golangci-lint` in any SKILL.md CRITICAL path
- [ ] Each replaced reference says "Run quality gates (see AGENTS.md)" or equivalent
- [ ] AGENTS.md Quality Gates section remains Go-specific (project config, not protocol)
- [ ] Skills are usable by a hypothetical Node.js or Rust project adopting SDP
- [ ] Go-specific examples in comments are OK if clearly marked as examples

...
- [ ] @build executes ONE workstream and stops after commit
- [ ] No "IMMEDIATELY start next workstream" or "AUTO-CONTINUE" rules
- [ ] Evidence lifecycle delegated to CLI or orchestrator
- [ ] @build ≤150 lines (down from 319)
- [ ] @build still produces `.sdp/ws-verdicts/{ws-id}.json` verdict file
- [ ] TDD cycle (Red→Green→Refactor) preserved
- [ ] @oneshot/sdp orchestrate still works with modified @build

...
|---|---|---|---|
| `sdp` | `internal` | `sdp` | protocol repo with 811 source files across 11 top-level modules. |
| `sdp_dev` | `internal` | `sdp_dev` | service repo with 1229 source files across 8 top-level modules. |

...
Historical note: many workstreams and beads IDs still use `sdp_dev-*` as a legacy label for the root repo. The Go module path was migrated to `github.com/fall-out-bug/sdp_lab` in F150-03. That is history, not a third repo.

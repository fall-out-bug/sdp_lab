...
- **F134** — AI-SDLC Phase FSM wiring (00-134-01 ... 00-134-07). Wire `sdp plan`, `sdp review`, and `sdp eval` over phase deltas, evidence gates, provenance attribution, disclosure labels, and phase-first skills. **Status: DONE.**

...
| **F018: Dead Code Purge** | 00-018-01, 00-018-02, 00-018-03 | M | Delete 3 broken skills (test, help, init) + 17 dead agents (57% of total). Fix Python→Go mismatch in bugfix/hotfix/tdd. Remove phantom CLI commands from skills (00-018-02, 00-018-03). Fix branch model (dev→master). ~4,300 lines removed. |

...
//
// Artifact contract: Resources reflect state generated by prior direct CLI
// invocations (with --output flags). MCP tool handlers return stdout and do not
// persist artifacts to disk. Resources become available only after the CLI has
// been run separately to produce the corresponding file.
